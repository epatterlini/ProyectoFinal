        ...
        <div class="container mt-5">
            ...
            <form action="GestionOradorServlet" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="tema" name="NumCliente" value="${usuario.cliente}" required>
                </div>

                <div class="form-group">
                    <label for="fechaAlta">Fecha Alta:</label>
                    <input type="date" class="form-control" id="fechaAlta" name="fechaAlta" value="${usuario.fechaAlta}" required>
                </div>
